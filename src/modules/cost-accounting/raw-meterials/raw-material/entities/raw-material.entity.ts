...
import { PurchaseInvoiceDetail } from 'src/modules/accounts/purchaseinvoicedetails/entities/purchaseinvoicedetail.entity';
...
export class RawMaterial {
    ...
    updated_at!: Date;
    @OneToMany(()=> PurchaseInvoiceDetail,(detail)=>detail.rawMaterial)
